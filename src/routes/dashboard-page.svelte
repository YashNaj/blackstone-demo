<script lang="ts">
  ...
  import DashboardLight from "$lib/img/dashboard-light.png";
  import DashboardDark from "$lib/img/dashboard-dark.png";
...
<div class="hidden flex-col md:flex">
  ...
  <div class="flex-1 space-y-4 p-8 pt-6">
    ...
    <Tabs.Root value="news" class="space-y-4">
      <Tabs.List>
        <Tabs.Trigger value="news">News</Tabs.Trigger>
        <Tabs.Trigger value="">Applications</Tabs.Trigger>
        <Tabs.Trigger value="reports">People</Tabs.Trigger>
        <Tabs.Trigger value="notifications">
          <Bell size={"1rem"} class="pr-1" />
          Notifications
        </Tabs.Trigger>
      </Tabs.List>
      <Tabs.Content value="news" class="space-y-4">
